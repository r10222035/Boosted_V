...
\section{Requirements of forward jet 2}% (fold)
\label{sec:requirements_of_forward_jet_2}
	...
	\label{sub:training_results_deltaeta}
		...
		\begin{table}[htpb]
			\centering
			\caption{The training results of the full event. The $N \times N$ means the resolution in the pixelating step. The $N \times N \to 75 \times 75$ means the samples are rescaled back to $75 \times  75$.}
			\label{tab:training_result_event_deltaeta}
			\resizebox{\textwidth}{!}{
			\begin{tabular}{c|c|c|cc|cc|cc|cc|cc|cc}
										 &                    & Overall & \multicolumn{2}{c}{$W^+W^+$} & \multicolumn{2}{c}{$W^-W^-$} & \multicolumn{2}{c}{$ZZ$} & \multicolumn{2}{c}{$W^+Z$} & \multicolumn{2}{c}{$W^-Z$} & \multicolumn{2}{c}{$W^+W^-$} \\
			    & Sample         & ACC   & AUC   & ACC   & AUC   & ACC   & AUC   & ACC   & AUC   & ACC   & AUC   & ACC   & AUC   & ACC   \\ \hline
			CNN & $75 \times 75$                  & 0.386 & 0.839 & 0.872 & 0.824 & 0.882 & 0.760 & 0.799 & 0.689 & 0.812 & 0.705 & 0.816 & 0.720 & 0.854 \\
			CNN & $25 \times 25$                  & 0.341 & 0.807 & 0.863 & 0.796 & 0.880 & 0.663 & 0.781 & 0.660 & 0.810 & 0.687 & 0.820 & 0.648 & 0.856 \\
			CNN & $15 \times 15$                  & 0.313 & 0.790 & 0.863 & 0.776 & 0.877 & 0.628 & 0.782 & 0.650 & 0.815 & 0.668 & 0.822 & 0.640 & 0.846 \\
			CNN & $25 \times 25 \to 75 \times 75$ & 0.343 & 0.814 & 0.863 & 0.797 & 0.878 & 0.674 & 0.781 & 0.666 & 0.817 & 0.688 & 0.818 & 0.664 & 0.854 \\
			CNN & $15 \times 15 \to 75 \times 75$ & 0.324 & 0.800 & 0.861 & 0.785 & 0.878 & 0.646 & 0.780 & 0.654 & 0.815 & 0.675 & 0.821 & 0.651 & 0.853
			\end{tabular}			
			}
		\end{table}

	% subsection training_results (end)		
% section requirements_of_forward_jet_2 (end)	
\section{\texorpdfstring{$\Delta \eta > 1$}{delta eta 1} sample}% (fold)
\label{sec:delta_eta_1_sample}
	This section generates the sample with loose $\Delta\eta$ cut at the MadGraph level, but still, imposes the $\Delta\eta > 2$ at the selection stage. The forward jets are required the matching condition: $\Delta R(q, j) < 0.3$ with  $p_\text{T} > \text{10 GeV}$.
...
% section delta_eta_1_sample (end)		
\section{Background sample}% (fold)
\label{sec:background_sample}
	...
	\subsection{Background sample selection}% (fold)
	...
	% subsection background_sample_selection (end)
	\subsection{Background sample plots}% (fold)
	...
	% subsection background_sample_plots (end)	
% section background_sample (end)		
\section{ResNet}% (fold)
\label{sec:resnet}
	...
	\label{sub:full_event_training_results}
		...
		\begin{table}[htpb]
			...
			\begin{tabular}{c|c|c|cc|cc|cc|cc|cc|cc}
										 &                    & Overall & \multicolumn{2}{c}{$W^+W^+$} & \multicolumn{2}{c}{$W^-W^-$} & \multicolumn{2}{c}{$ZZ$} & \multicolumn{2}{c}{$W^+Z$} & \multicolumn{2}{c}{$W^-Z$} & \multicolumn{2}{c}{$W^+W^-$} \\
					  & Sample             & ACC   & AUC   & ACC   & AUC   & ACC   & AUC   & ACC   & AUC   & ACC   & AUC   & ACC   & AUC   & ACC   \\ \hline
			CNN        & \multirow{2}{*}{1} & 0.417 & 0.852 & 0.858 & 0.846 & 0.866 & 0.794 & 0.842 & 0.728 & 0.834 & 0.698 & 0.834 & 0.707 & 0.833 \\
			CNN-ResNet &                    & 0.412 & 0.849 & 0.855 & 0.838 & 0.865 & 0.792 & 0.841 & 0.728 & 0.834 & 0.696 & 0.834 & 0.707 & 0.833
			\end{tabular}			
			}
		\end{table}
		...
		\begin{table}[htpb]
            ...
            & Overall & \multicolumn{2}{c}{$W^+W^+$} & \multicolumn{2}{c}{$W^-W^-$} & \multicolumn{2}{c}{$ZZ$} & \multicolumn{2}{c}{$W^+Z$} & \multicolumn{2}{c}{$W^-Z$} & \multicolumn{2}{c}{$W^+W^-$} \\ 
						& ACC   & AUC   & ACC   & AUC   & ACC   & AUC   & ACC   & AUC   & ACC   & AUC   & ACC   & AUC   & ACC   \\ \hline
			CNN         & 0.415 & 0.851 & 0.855 & 0.844 & 0.861 & 0.789 & 0.838 & 0.699 & 0.831 & 0.705 & 0.836 & 0.727 & 0.841 \\
			std.		& 0.001 & 0.001 & 0.001 & 0.001 & 0.001 & 0.002 & 0.001 & 0.001 & 0.001 & 0.001 & 0.001 & 0.002 & 0.001 \\ \hline
			CNN-ResNet  & 0.404 & 0.846 & 0.855 & 0.837 & 0.859 & 0.769 & 0.835 & 0.691 & 0.831 & 0.700 & 0.836 & 0.715 & 0.841 \\
			std.		& 0.005 & 0.003 & 0.001 & 0.003 & 0.002 & 0.011 & 0.002 & 0.003 & 0.001 & 0.004 & 0.001 & 0.008 & 0.001
			\end{tabular}
			}
		\end{table}
	...
	% subsection full_event_training_results (end)
% section resnet (end)		
\section{ResNet with background sample}% (fold)
\label{sec:resnet_with_background_sample}
	...
	\label{sub:full_event_training_results_with_background}
		...
		\begin{table}[htpb]
			...
			\resizebox{\textwidth}{!}{
			\begin{tabular}{c|c|c|c|c|c|c|c|c}
					   & ACC         &\multicolumn{7}{c}{AUC}                                               \\
					   & Overall     & $W^+W^+$ & $W^-W^-$ & $ZZ$  & $W^+Z$ & $W^-Z$ & $W^+W^-$ & Background \\ \hline
			CNN-ResNet & 0.502       & 0.875    & 0.867    & 0.833 & 0.752  & 0.757  & 0.772    & 0.998      \\
			std.       & 0.002       & 0.002    & 0.002    & 0.003 & 0.002  & 0.002  & 0.003    & 0.001     
			\end{tabular}			
			}
		\end{table}
	...
	% subsection full_event_training_results_with_background (end)

% section resnet_with_background_sample (end)		
\end{document} 
