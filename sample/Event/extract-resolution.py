#!/usr/bin/env python
# coding: utf-8
# python extract-resolution.py <kappa value> <resolution> <root_file_path>
# python extract-resolution.py 0.15 25 <root_file_path>
...
def main():
    ...
    output_dir = os.path.join(output_dir, f'event_samples_kappa{kappa}-{nevent//1000}k-{res}x{res}')
